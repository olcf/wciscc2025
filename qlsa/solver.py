...
python solver.py -case sample-tridiag -casefile input_vars.yaml -s 100  -backtyp real-iqm -backmet garnet:mock
'''
...
parser.add_argument("-backtyp", "--backend_type",  type=str, default='ideal', required=False, help="Type of the backend: 'ideal' 'real-ibm' 'real-iqm'")
parser.add_argument("-backmet", "--backend_method",  type=str, default='statevector', required=False, help="Method/name of the backend. E.g. 'statevector' 'fake_sherbrooke' 'ibm_sherbrooke' 'garnet' 'garnet:mock' ")
